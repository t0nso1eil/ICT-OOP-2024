...
public class UpdateSpotStatusHandler : IRequestHandler<UpdateSpotStatusCommand, PublicSpotInfoResponse>
{
    ...
    public async Task<PublicSpotInfoResponse> Handle(UpdateSpotStatusCommand request, CancellationToken cancellationToken)
    {
