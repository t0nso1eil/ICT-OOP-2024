...
public class UpdateSessionStatusHandler : IRequestHandler<UpdateSessionCommand, PublicSessionInfoResponse>
{
    ...
    public async Task<PublicSessionInfoResponse> Handle(UpdateSessionCommand request, CancellationToken cancellationToken)
    {
