...
public class PsychologistService : IPsychologistService
{
    ...
    {
        var userInfo = new RegistrateUserRequest(
            registratePsychologistRequest.FirstName,
    ...
    public ICollection<PublicPsychologistInfoResponse> GetAllPsychologists()
    {
        ...
        return psychos.Select(psycho => new PublicPsychologistInfoResponse(
            psycho.User.FirstName,
            psycho.User.LastName,
            psycho.User.Email,
            psycho.User.PhoneNumber,
            psycho.User.Birthday,
            psycho.User.Age,
            psycho.User.AdditionalInfo,
            psycho.User.RegistrationDate,
            psycho.Specialization,
            psycho.ExperienceStartDate,
            psycho.ExperienceYears,
            psycho.PricePerHour,
            psycho.Rate)).ToList();
    }
