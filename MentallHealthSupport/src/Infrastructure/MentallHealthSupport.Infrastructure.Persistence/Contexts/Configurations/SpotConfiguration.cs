...
public class SpotConfiguration : IEntityTypeConfiguration<SpotModel>
{
    public void Configure(EntityTypeBuilder<SpotModel> builder)
    {
        ...
        builder.Property(spot => spot.Id).HasColumnName("spot_id").HasColumnType("character varying");
        ...
        builder.Property(spot => spot.Status).HasColumnName("status").HasColumnType("character varying");
